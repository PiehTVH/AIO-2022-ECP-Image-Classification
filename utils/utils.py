...
def convert_weights(ckpt, source_model, target_model, config, out_path):
    source_state_dict = source_model.load_from_checkpoint(ckpt, config=config).state_dict()
    target_state_dict = target_model.state_dict()
    for layer in target_state_dict:
        target_state_dict[layer] = source_state_dict[layer]
    torch.save(target_state_dict, out_path)
